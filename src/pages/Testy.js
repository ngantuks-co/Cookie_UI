    ...
    <div>
        ...
        <div className='mt-5'>
          ...
          <div id="carouselExampleIndicators" class="carousel slide py-3" style={{height: "290px"}} data-bs-ride="true">
            ...
            <div class="carousel-inner text-center">
              ...
              <div class="carousel-item text-secondary fs-5">
                <p>
                  "This is one of the best bakers in KL! My favourite is their valrhona cakes (hazelnut & raspberry) and the gateau fromage (which is basically a cheesecake) is awesome too! Their mini desserts are great if you want it for a small number of people and want to try all the different types of cakes they have."
                </p>
        ...
        <div>
          ...
          <div className="mt-5 d-md-flex gap-5">
            <div className='fs-5 w-100 mb-sm-5'>
              ...
              <h5 className="py-4">
                25 Chinnese New Year Whishes in Chinese & English for CNY 2022!
              </h5>
              <p>
                One of the best ways to send your family and friends your good blessings for the year 2022 is of course, through words of encouragement,...
              </p>
            ...
            <div className='fs-5 w-100'>
              ...
              <h5 className="py-4">
                2 captivating 2021 Christmas cakes that will WOW your friends and family!
              </h5>
              <p>
                Don't you think it's time to spice up your Christmas dessert table with something new, fresh, and jaw-dropping all at the same time? We do!...
              </p>
              <a href="#" className='text-secondary'>Read more</a>
            </div>
          </div>
      ...
      <div style={{backgroundColor: "#FFF7B2"}}>
        <div className="container py-5 text-secondary fs-5 mt-5">
          <div className='row d-md-inline '>
            <div className="col">
              <p className="fw-bold">Lachér Patisserie</p>
              <p style={{textAlign: 'justify'}}>We serve quality French desserts in Malaysia. All our cakes are professionally made from scratch using only the finest halal ingredients. We provide same-day delivery to KL and Selangor (T&Cs apply).</p>
            </div>
            <div className='col'>
            ...
            <div className="col">
              ...
              <a href="#" className='text-decoration-none text-secondary d-block'>Same Day Cake & Dessert Delivery</a>
              <a href="#" className='text-decoration-none text-secondary d-block pt-2'>Free Delivery to KL & Selangor (Min Amount Spend)</a>
              <a href="#" className='text-decoration-none text-secondary d-block pt-2'>Our Store Location (For Pickup Only)</a>
              <a href="#" className='text-decoration-none text-secondary d-block pt-2'>Allergen and Diet Information</a>
              <a href="#" className='text-decoration-none text-secondary d-block pt-2'>FAQ</a>
              <a href="#" className='text-decoration-none text-secondary d-block pt-2'>Blogs</a>
              <a href="#" className='text-decoration-none text-secondary d-block pt-2'>Join Our Team</a>
              <a href="#" className='text-decoration-none text-secondary d-block pt-2'>Contact Us</a>
              <a href="#" className='text-decoration-none text-secondary d-block pt-2'>Delivery/Refund/Cancellation Policy</a>
              <a href="#" className='text-decoration-none text-secondary d-block pt-2'>Terms of Service</a>
              <a href="#" className='text-decoration-none text-secondary d-block pt-2'>Privacy Policy</a>
            </div>
            <div className="col">
