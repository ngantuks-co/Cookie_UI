    ...
    <div>
      <div className="">
        <img
          ...
          alt="..."
          className=" w-100"
          style={{ height: "50vh", objectFit: "cover", position: "absolute", zIndex: "-1" }}
        />
        <div className="pt-4 ps-4 ">
          <div class=" card text-center" style={{ width: "17rem" }}>
            <div class="card-body mt-4">
              ...
              <p class="card-text">A-1-11, Eve Suite, Jalan PJU 1A/41, Ara Damansara, 47301, Petaling Jaya, Selangor.</p>
